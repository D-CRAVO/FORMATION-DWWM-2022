function afficherDate() {
    ...
    */
    ...
    document.getElementById("txtdate").value = datejour;

}

var monbtndate = document.querySelector("#btndate");

monbtndate.addEventListener("click", afficherDate)

/* monbtndate.addEventListener("click", function() {
    let machaine = afficherDate();
...
//document.querySelector("#btnheure").addEventListener("click", function() {afficherHeure()});
