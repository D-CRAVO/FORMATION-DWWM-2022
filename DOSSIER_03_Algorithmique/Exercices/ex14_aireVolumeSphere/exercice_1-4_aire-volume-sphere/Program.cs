...
namespace ex14_aireVolumeSphere
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("L'aire de la sphère est de {0:#,###0.0000} m2", aire);
            double volume = Math.Round((double)4 / 3 * Math.PI * Math.Pow(rayon, 3), 2);
            Console.WriteLine("Le volume de la sphère est de {0:#,###0.0000} m3", volume);
        }
    }
}
